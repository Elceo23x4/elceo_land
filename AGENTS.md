...
- The approved landing visual reference is `docs/design/references/approved-landing-reference.png`. Do not replace its composition with generic SaaS/fintech layouts.
