...
export default function ArchitectureProof() {
  return <main><h1>M1 architecture verification</h1><p>Engineering fixture only. No product interface is implemented.</p>
    ...
    <Arrow aria-label="Source-safe SVG component fixture" role="img" width={32} height={32} />
    <img src="/m1-assets/arrow-up.svg" alt="Unmodified SVG URL fixture" width={32} height={32} />
  </main>;
}
